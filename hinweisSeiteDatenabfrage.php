    ...
    <?php include 'include/menuleiste.php'?>
        <div class="inhalt">
            <div class="datenverarbeitung">          
                ...
                <?php include 'include/datenfelder_abfragen.php';?>
                <div class="datenverarbeitung_hinweisText">
                    ...
                    if($_anbieter == null){
                        echo "<br><p>Das Feld darf nicht leer bleiben.</p>";
                    }else{
                        $sql = "SELECT anbieter, password FROM `login` WHERE anbieter LIKE '{$_anbieter}%'";
                        $daten = $con->query($sql);
                        if($daten->num_rows==0){
                            echo "<br><p>Keinen Datenbankeintrag gefunden.</p>";
                        }else{
                            echo "<br><p>Zu deiner Eingabe gibt es folgenden Eintrag:<br>";
                            echo "<br><b>Anbieter</b> | ";
                            echo "<b>Passwort</b>";
                            while ($i = $daten->fetch_assoc()){
                                echo "<br>".$i["anbieter"]. "   |    ". $i["password"];
                            }
                        }
                        $con->close();
                    }
