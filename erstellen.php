...
<head>
    ...
    <script type="text/javascript" src="js/passwortGenerator.js"></script>
    ...
    <?php include 'include/menuleiste.php'?>
        <div class="inhalt">
            ...
            <div class="datenfelder">
                <form>
                    <input type="button" id="erstellen" value="Passwort erstellen" onclick="newPassword()">
                    <p><b>neues Passwort: <input type="text" id="newpassword"/></p>
                </form>
            </div>
        </div>
        </div>
